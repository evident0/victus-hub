...
class HomePage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        fan1_wrap = QWidget()
        fan1_l = QVBoxLayout(fan1_wrap)
        fan1_l.setContentsMargins(0, 18, 0, 0)
        fan1_l.setSpacing(0)
        fan1_l.addWidget(hairline())
        fan1_l.addSpacing(18)
        fan1_l.addWidget(self._fan1)
        fan2_wrap = QWidget()
        fan2_l = QVBoxLayout(fan2_wrap)
        fan2_l.setContentsMargins(20, 18, 0, 0)
        fan2_l.setSpacing(0)
        fan2_l.addWidget(hairline())
        fan2_l.addSpacing(18)
        fan2_l.addWidget(self._fan2)
        grid.addWidget(fan1_wrap, 1, 0)
        grid.addWidget(fan2_wrap, 1, 1)

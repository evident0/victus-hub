"""Single-instance guard for HP Helper.
...
def default_socket_path() -> str:
    ...
    return os.path.join(base, "hp-helper-single-instance.sock")
...
class SingleInstanceGuard(QObject):
    ...
    def claim(self) -> bool:
        ...
        if probe.waitForConnected(500):
            ...
            probe.deleteLater()
            logger.info("Another HP Helper instance is running; asked it to raise.")
            return False
